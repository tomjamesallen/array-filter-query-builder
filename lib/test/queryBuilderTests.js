...
function compareNestedArrays(array1, array2) {
  ...
  array1.forEach(function (array1Item, i) {
    var array2Item = array2[i];
    if ((typeof array2Item === 'undefined' ? 'undefined' : _typeof(array2Item)) !== 'object') {
      isEqual = false;
      return;
    }
    array1Item.forEach(function (array1NestedItem, i) {
      var array2NestedItem = array2Item[i];
...
describe('A `Query` instance should return an empty array from `serialise`', function () {
...
describe('A `Query` instance should accept a serialised array of query arguments', function () {
  it('should accept a serialised array of query arguments in the constructor method and then return an array from `serialise` that is `shallowequal`.', function () {
    ...
    var serialised = query.serialise();
    (0, _chai.expect)(compareNestedArrays(_query2.default, serialised)).to.equal(true);
  });
});
...
describe('A `Query` instance’s `replace` method should behave in the same way as the `add` method, but with `reset` set to true.', function () {
  ...
  it('should accept an array of query arguments, and delete any existing query arguments that match the `fieldKey`s.', function () {
    ...
    var isEqual = compareNestedArrays(_query4.default, newItems);
...
describe('A `Query` instance should be clone-able', function () {});