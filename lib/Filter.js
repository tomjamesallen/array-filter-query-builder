...
var Filter = function () {
  ...
  _createClass(Filter, [{
    ...
    value: function _getFieldValue(item, fieldKey) {
      ...
      // console.log('_getFieldValue', {
      //   item, fieldKey, filterFields
      // })
    ...
    value: function _testComparator(fieldValue, comparator, testValue) {
      if (typeof _comparatorMethods2.default[comparator] === 'function') {
        return _comparatorMethods2.default[comparator](fieldValue, testValue);
